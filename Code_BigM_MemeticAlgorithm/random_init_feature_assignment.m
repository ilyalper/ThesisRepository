function [init_rand_infeasibility_count,parent_assignments,parent_centers ] = random_init_feature_assignment(p,d,q,n,data,init_start,init_end,parent_assignments,parent_centers)
